...
import { normalizeUsername, validateStrongPassword, validateUsername } from '@/lib/auth/credentialsPolicy';
            ...
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  placeholder="π.χ. agroUser123"
                />
                <p className="mt-1 text-xs text-slate-500">
                  Επιτρέπονται μόνο γράμματα και αριθμοί, χωρίς ειδικούς χαρακτήρες όπως _ ή .
                </p>
              </div>
            )}
