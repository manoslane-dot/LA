                        ...
                        <article key={item.id} className="flex flex-col rounded-lg border border-stone-200 bg-stone-50 p-3 shadow-sm sm:p-3.5">
                          {productImages.length > 0 && (
                            <button
                              ...
                              className="mb-2.5 aspect-square w-[86%] max-w-full self-center overflow-hidden rounded-md border border-stone-200 bg-white"
                          ...
                          <div className="mt-auto">
                            <button type="button" onClick={() => openRequestForm(item)} className="w-full rounded-md bg-emerald-700 px-3 py-2 text-[11px] font-bold text-white transition-colors hover:bg-emerald-800 sm:px-3.5 sm:py-2.5 sm:text-sm">
                              Αποστολή αιτήματος
                            </button>
                          </div>
                        </article>
