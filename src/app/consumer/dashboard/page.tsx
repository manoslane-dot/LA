                ...
                {filteredAndSortedProducts.length === 0 ? (
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-1.5 sm:grid-cols-2 sm:gap-2.5 lg:grid-cols-3">
                      ...
                      return (
                        <article key={item.id} className="flex flex-col rounded-lg border border-stone-200 bg-stone-50 p-2.5 shadow-sm sm:p-3">
                          ...
                          <div className="mb-1.5 flex items-start justify-between gap-2">
                            ...
                            <span className="rounded-full bg-emerald-100 px-2 py-0.5 text-[10px] font-medium text-emerald-800">{item.status}</span>
                          </div>
                          ...
                          <div className="mt-auto">
                            <button type="button" onClick={() => openRequestForm(item)} className="w-full rounded-md bg-emerald-700 px-2.5 py-2 text-[10px] font-bold text-white transition-colors hover:bg-emerald-800 sm:px-3 sm:py-2 sm:text-[11px]">
                              Αποστολή αιτήματος
                            </button>
                          </div>
                        </article>
