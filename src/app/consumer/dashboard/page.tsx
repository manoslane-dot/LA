                      ...
                      return (
                        <article key={item.id} className="flex flex-col rounded-lg border border-stone-200 bg-stone-50 p-2 shadow-sm sm:p-2.5">
                          ...
                          {useDistance && itemDistance !== null && (
                            <p className="mb-2 flex items-center justify-start gap-1 text-left text-xs font-semibold text-emerald-700">
                              <MapPin className="h-3 w-3" />
                              {formatDistance(itemDistance)}
                            </p>
                          )}
                          <p className="mb-2 w-full text-left text-sm text-stone-600 sm:text-[13px]">
