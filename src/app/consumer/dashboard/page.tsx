                ...
                {filteredAndSortedProducts.length === 0 ? (
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-1.5 sm:grid-cols-2 sm:gap-2.5 lg:grid-cols-3">
                      ...
                      return (
                        <article key={item.id} className="flex flex-col rounded-lg border border-stone-200 bg-stone-50 p-1.5 shadow-sm sm:p-2">
                          ...
                          <div className="mb-1.5 flex items-start justify-between gap-2">
                            <h3 className="text-[10px] font-bold leading-4 text-stone-900 sm:text-[11px]">{item.title}</h3>
                            <span className="rounded-full bg-emerald-100 px-1.5 py-0.5 text-[9px] font-medium text-emerald-800">{item.status}</span>
                          </div>
                          {useDistance && itemDistance !== null && (
                            <p className="mb-1.5 flex items-center gap-1 text-[9px] font-semibold text-emerald-700 sm:text-[10px]">
                              <MapPin className="h-2.5 w-2.5" />
                              {formatDistance(itemDistance)}
                            </p>
                          )}
                          <p className="mb-1.5 text-[9px] leading-4 text-stone-600 sm:text-[10px]">
                          ...
                          <div className="mt-auto">
                            <button type="button" onClick={() => openRequestForm(item)} className="w-full rounded-md bg-emerald-700 px-2.5 py-1.5 text-[9px] font-bold text-white transition-colors hover:bg-emerald-800 sm:px-3 sm:py-2 sm:text-[10px]">
                              Αποστολή αιτήματος
                            </button>
                          </div>
                        </article>
